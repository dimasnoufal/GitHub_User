...
import com.dimasnoufal.githubuser.databinding.FragmentFollowerBinding
import com.dimasnoufal.githubuser.model.ItemsItem
import com.dimasnoufal.githubuser.utils.AppConstant
import com.dimasnoufal.githubuser.viewmodels.FollowerViewModel
...
class FollowerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        followerViewModel.getFollowerList(user!!.login!!)

        followerViewModel.followerList.observe(viewLifecycleOwner) { res ->
            when (res) {
